...
require_text "$README" 'docs/changes/archive/2026-06-11-18-修复GitHub-CI并更新仓库文档/tests/\*\.sh' "README 必须列出根目录 docs/changes/archive/2026-06-11-18-修复GitHub-CI并更新仓库文档/tests/*.sh 业务测试"
...
require_text "$RELEASE_SPEC" 'docs/changes/archive/2026-06-11-18-修复GitHub-CI并更新仓库文档/tests/\*\.sh' "release automation 规格必须列出 docs/changes/archive/2026-06-11-18-修复GitHub-CI并更新仓库文档/tests/*.sh"
...
require_text "$CI_WORKFLOW" 'for script in docs/changes/archive/2026-06-11-18-修复GitHub-CI并更新仓库文档/tests/\*\.sh' "CI workflow 必须遍历根目录 docs/changes/archive/2026-06-11-18-修复GitHub-CI并更新仓库文档/tests/*.sh"
...
require_text "$RELEASE_WORKFLOW" 'for script in docs/changes/archive/2026-06-11-18-修复GitHub-CI并更新仓库文档/tests/\*\.sh' "Release workflow 必须遍历根目录 docs/changes/archive/2026-06-11-18-修复GitHub-CI并更新仓库文档/tests/*.sh"
