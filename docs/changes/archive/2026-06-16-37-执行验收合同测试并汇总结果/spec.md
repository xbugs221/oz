...
- 测试文件：`docs/changes/37-执行验收合同测试并汇总结果/tests/test_acceptance_run_contract_surface.sh`
...
- 测试文件：`docs/changes/37-执行验收合同测试并汇总结果/tests/test_acceptance_run_success_contract.sh`
...
- 测试文件：`docs/changes/37-执行验收合同测试并汇总结果/tests/test_acceptance_run_failure_contract.sh`
...
- 测试文件：`docs/changes/37-执行验收合同测试并汇总结果/tests/test_acceptance_run_stage_gate_contract.sh`
