  ...
  "acceptance_matrix": [
    {
      "id": "contract-demo",
      "status": "passed",
      "artifact": "docs/changes/archive/2026-06-10-12-收窄验收gate到提案范围/tests/test_qa_acceptance_scope_contract.sh",
...
func TestCleanQAStillRejectsUnknownAcceptanceMatrixID(t *testing.T) {
	qa := QA{
		...
		AcceptanceMatrix: []AcceptanceResult{
			{ID: "contract-demo", Status: "passed", Artifact: "docs/changes/archive/2026-06-10-12-收窄验收gate到提案范围/tests/test_qa_acceptance_scope_contract.sh", Evidence: "contract passed"},
...
func scopedAcceptance() Acceptance {
	return Acceptance{
		...
		RequiredTests: []AcceptanceTest{
			{ID: "contract-demo", Source: "change_contract", Path: "docs/changes/archive/2026-06-10-12-收窄验收gate到提案范围/tests/test_qa_acceptance_scope_contract.sh", Command: "bash docs/changes/archive/2026-06-10-12-收窄验收gate到提案范围/tests/test_qa_acceptance_scope_contract.sh", Purpose: "prove scoped QA acceptance", Assertions: []string{"QA acceptance_matrix covers only ids declared by acceptance.json"}},
		},
