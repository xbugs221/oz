...
- [x] 先运行创建阶段契约测试：`bash docs/changes/42-拆除固定子代理编排/tests/test_remove_fixed_subagents_contract.sh`
...
- [x] 验证。
  - [x] 运行 `bash docs/changes/42-拆除固定子代理编排/tests/test_remove_fixed_subagents_contract.sh`。
