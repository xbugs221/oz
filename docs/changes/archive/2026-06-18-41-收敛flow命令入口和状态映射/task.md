...
- [x] 先运行创建阶段契约测试：`bash docs/changes/archive/2026-06-18-41-收敛flow命令入口和状态映射/tests/test_flow_boundary_convergence_contract.sh`
...
- [x] 验证。
  - 运行 `bash docs/changes/archive/2026-06-18-41-收敛flow命令入口和状态映射/tests/test_flow_boundary_convergence_contract.sh`。
  - 运行 `go test ./... -count=1`。
